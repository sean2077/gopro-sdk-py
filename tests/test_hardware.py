"""Hardware integration tests - requires real GoPro camera.

Tests that require actual camera hardware including BLE connection, HTTP connection,
status queries, recording control, etc.
"""
